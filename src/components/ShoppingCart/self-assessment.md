...
It works perfectly fine and the code is easy to understand.
- **Areas for Improvement**
  - List areas where the component could be improved.
Maybe using the other method where i can use an object to manage the states.

- **Action Plan**
I just need to practice the 2nd method more, i will use it on other components on my own for practice.
